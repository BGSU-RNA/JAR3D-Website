...
FN = "C:\\Documents and Settings\\zirbel\\My Documents\\My Dropbox\\BGSURNA\\Motifs\\Correspondences\\" + MN + "_Correspondences.txt"
...
for a in sorted(aligdata.iterkeys()):
  f.write('<tr><td><font color = "' + DisplayColor[a]+ '">'+a+'</td>')
